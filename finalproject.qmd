...
Finally, we create a decision tree that categorizes air monitor observations. We decided to focus on a single pollutant, Nitrogen Dioxide (N02), which is a gas measured at every monitoring station. Burning fuels, whether it be in a power plant or the engine of a car, generates N02 and its sibling gases in the nitrogen oxide family. These gases can, over long periods of exposure, cause or worsen breathing difficulties in children. This is why it's important to have an accurate understanding of whether location plays a significant role in concentrations of N02 as it may have a negative impact on kids living nearby even if measured quantities are not high-dosage.
